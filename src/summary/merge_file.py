...
def main():
    ...
    parser.add_argument('--input_data_path', type=str,
                        default='/data/groups/QY_LLM_Other/meisen/iclr2024/summary/zeroshot_eval/wow',
                        help="The folder where the chunk files you want to merge are located.",
                        )
    parser.add_argument('--output_file', type=str,
                        default='/data/groups/QY_LLM_Other/meisen/iclr2024/summary/zeroshot_eval/wow/dev_psg.jsonl',
                        )

    args = parser.parse_args()
    merge_jsonl_files(args.input_data_path, args.output_file)
